...
// Credit: https://gist.github.com/pietro-lopes/1471e43c6acef411fd98f10908185fae

const $ResourcePackLoader = Java.loadClass( "net.minecraftforge.resource.ResourcePackLoader" )
...
function loadPack(type, modId) {
    ...
    if (modId == "minecraft") {
        ...
        let resourcePack = loadMod(type, modId)
        resourcePack && pack.push(resourcePack)
    }
    return pack
}

function loadMod(type, modId) {
    let resourcePack
    try {
